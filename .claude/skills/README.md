...
| `spring-data-jdbc.md` | ListCrudRepository, entity mapping, @Query, type converters, pagination | `new-repository`, `new-feature`, `performance-review` |
...
A skill shows you how to write a Spring Data JDBC repository.
The rule (`spring-data-jdbc.md`) tells you what you must never do in that repository.
